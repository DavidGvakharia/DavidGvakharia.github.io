document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        ge: {
            ...
            about_p: "მე მქვია დავითი და ვარ Full-Stack-Creator რაც ნიშნავს იმას, რომ ვმუშაობ 3D ანიმაციის, რენდერის, მოდელირების განხრით, ასევე გრაფიკული დიზაინის და ვიდეო მონტაჟის მიმართულებით. ვცდილობ, რომ განვითარდე და ყოველ ჯერზე უკეთესი შედეგი დავდო. ჩემი მიზანი მარტივია- შექვმნა ისეთი რამ, რასაც ადმიანები ღრმად ჩაწვდებიან და თავად განიცდიან",
